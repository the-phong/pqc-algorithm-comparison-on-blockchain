...
This folder is an isolated copy of the blockchain demo configured for SPHINCS+.
...
Notes:
- `pqc_demo.py` stores the SPHINCS+ signature and public key in local off-chain storage by default at `../../shared/offchain_store/`.
