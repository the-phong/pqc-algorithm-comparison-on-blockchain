...
def main() -> None:
    ...
    pqc_signature = sphincs_sha2_128f_simple.sign(secret_key, payload)
    pqc_sign_seconds = time.perf_counter() - pqc_sign_start

    pqc_verify_start = time.perf_counter()
    verified = sphincs_sha2_128f_simple.verify(public_key, payload, pqc_signature)
    ...
    result = {
        ...
        "pqc": {
            ...
            "public_key_size_bytes": sphincs_sha2_128f_simple.PUBLIC_KEY_SIZE,
            "secret_key_size_bytes": sphincs_sha2_128f_simple.SECRET_KEY_SIZE,
